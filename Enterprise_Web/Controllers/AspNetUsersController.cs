...
namespace Enterprise_Web.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,facID")] AspNetUser aspNetUser)
        {
            ...
            ViewBag.facID = new SelectList(db.Faculties, "facID", "facName", aspNetUser.facID);
            return View(aspNetUser);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,facID")] AspNetUser aspNetUser)
        {
            if (ModelState.IsValid)
            {
